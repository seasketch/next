...
- Client GraphQL operation definitions must live in `.graphql` files under `packages/client/src/queries/`. Do not define queries/mutations inline in React component `.tsx` files.
