var MapBoxGLEsriSources = (function () {
	...
	var utils$3 = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		'default': utils$2,
	...
	class ArcGISDynamicMapService {
	                    ...
	                    if (isFolder) {
	                        ...
	                        return {
	                            ...
	                            defaultVisibility: hiddenIds.has(lyr.id)
	                                ? false
	                                : lyr.defaultVisibility,
	                            metadata: (0, utils$3.generateMetadataForLayer)(this.options.url + "/" + lyr.id, this.serviceMetadata, lyr),
	                            parentId: lyr.parentLayer
	                                ? lyr.parentLayer.id.toString()
	                                : undefined,
	                            legend: (0, utils$3.makeLegend)(legendData, lyr.id),
	                        };
	                    }
	                }),
	    ...
	    async getComputedProperties() {
	        ...
	        const attribution = (0, utils$3.contentOrFalse)(layers.layers[0].copyrightText) ||
	            (0, utils$3.contentOrFalse)(serviceMetadata.copyrightText) ||
	            (0, utils$3.contentOrFalse)((_b = serviceMetadata.documentInfo) === null || _b === void 0 ? void 0 : _b.Author) ||
	            undefined;
	        ...
	        return {
	            minzoom,
	            maxzoom,
	            bounds: await (0, utils$3.extentToLatLngBounds)(serviceMetadata.fullExtent),
	            attribution,
	        };
	    }
	...
	var ArcGISVectorSource = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		'default': ArcGISVectorSource_1,
		__moduleExports: ArcGISVectorSource_1
	}, [ArcGISVectorSource_1]);

	var ArcGISRESTServiceRequestManager_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.fetchWithTTL = exports.ArcGISRESTServiceRequestManager = void 0;
	...
	var ArcGISRESTServiceRequestManager = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		'default': ArcGISRESTServiceRequestManager_1,
		__moduleExports: ArcGISRESTServiceRequestManager_1
	}, [ArcGISRESTServiceRequestManager_1]);
	...
	class ArcGISTiledMapService {
	                    ...
	                    tableOfContentsItems: [
	                        {
	                            ...
	                            metadata: (0, utils$3.generateMetadataForLayer)(this.options.url, this.serviceMetadata, this.layerMetadata.layers[0]),
	                            legend: (0, utils$3.makeLegend)(legendData, legendData.layers[0].layerId),
	                        },
	                    ],
	                    supportsDynamicRendering: {
	                        layerOrder: false,
	    ...
	    async addToMap(map) {
	        ...
	        if (this.map.getSource(this.sourceId)) {
	            (0, utils$3.replaceSource)(this.sourceId, this.map, sourceData);
	        }
	        else {
	...
	var ArcGISTiledMapService = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		'default': ArcGISTiledMapService_1,
		__moduleExports: ArcGISTiledMapService_1
	}, [ArcGISTiledMapService_1]);
	...
	var fetchData = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		'default': fetchData_1,
		__moduleExports: fetchData_1
	}, [fetchData_1]);
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.getOrCreateQuantizedVectorRequestManager = exports.QuantizedVectorRequestManager = void 0;
	...
	var QuantizedVectorRequestManager = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		'default': QuantizedVectorRequestManager_1,
		__moduleExports: QuantizedVectorRequestManager_1
	}, [QuantizedVectorRequestManager_1]);
	...
	class ArcGISFeatureLayerSource {
	                    ...
	                    tableOfContentsItems: [
	                        {
	                            ...
	                            id: this.sourceId,
	                            label: layer.name,
	                            metadata: (0, utils$3.generateMetadataForLayer)(this.options.url.replace(/\/\d+$/, ""), serviceMetadata, layer),
	                            glStyle: glStyle,
	                        },
	                    ],
	                };
	    ...
	    async getComputedProperties() {
	        ...
	        return {
	            minzoom: 0,
	            maxzoom: 24,
	            bounds: (await (0, utils$3.extentToLatLngBounds)((layer === null || layer === void 0 ? void 0 : layer.extent) || serviceMetadata.fullExtent)) || undefined,
	            attribution,
	            supportedFormats,
	        };
	    }
	    ...
	    async getGLStyleLayers() {
	        if (this._glStylePromise) {
	            ...
	            this._glStylePromise = new Promise(async (resolve, reject) => {
	                ...
	                const styleInfo = (0, dist$1.styleForFeatureLayer)(this.options.url.replace(/\/\d+$/, ""), this.layerId, this.sourceId, layer);
	    ...
	    async fetchTiles() {
	        ...
	        try {
	            ...
	            await Promise.all(tiles.map((tile) => (async () => {
	                ...
	                return (0, ArcGISRESTServiceRequestManager.fetchWithTTL)(`${`${this.options.url}/query?${params.toString()}`}`, 60 * 10, this.cache, { signal: (_a = this.abortController) === null || _a === void 0 ? void 0 : _a.signal }, `${this.options.url}/query/tiled/${tilebelt.tileToQuadkey(tile)}/${params.get("f")}`)
	...
	exports.default = (symbol, sourceId) => {
	    const { color, opacity } = (0, utils$1.colorAndOpacity)(symbol.color);
	    let strokeWidth = (0, utils$1.ptToPx)(symbol.width || 1);
	    if (strokeWidth === -1) {
	        strokeWidth = 1;
	    }
	    ...
	    if (style !== "esriSLSSolid") {
	        layer.paint["line-dasharray"] = linePatterns.default[style](strokeWidth);
	    }
	    return [layer];
	};
	});
	...
	exports.default = (symbol, sourceId, imageList) => {
	    ...
	    let useFillOutlineColor = symbol.outline &&
	        (0, utils$1.ptToPx)(symbol.outline.width || 1) === 1 &&
	        ...
	        case "esriSFSSolid":
	            if (symbol.color && symbol.color[3] === 0) {
	                ...
	                layers.push({
	                    ...
	                    source: sourceId,
	                    paint: {
	                        "fill-color": (0, utils$1.rgba)(symbol.color),
	                        ...(useFillOutlineColor
	                            ? { "fill-outline-color": (0, utils$1.rgba)(symbol.outline.color) }
	                            : {}),
	                    },
	                });
	            }
	    ...
	    if (symbol.outline && !useFillOutlineColor) {
	        let outline = (0, esriSLS.default)(symbol.outline, sourceId);
	        layers.push(...outline);
	    }
	    return layers;
	};
	...
	function symbolToLayers(symbol, sourceId, imageList, serviceBaseUrl, sublayer, legendIndex) {
	    ...
	    switch (symbol.type) {
	        case "esriSFS":
	            layers = (0, esriSFS.default)(symbol, sourceId, imageList);
	            break;
	        case "esriPFS":
	            layers = (0, esriPFS.default)(symbol, sourceId, imageList);
	            break;
	        case "esriSLS":
	            layers = (0, esriSLS.default)(symbol, sourceId);
	            break;
	        case "esriPMS":
	            layers = (0, esriPMS.default)(symbol, sourceId, imageList, serviceBaseUrl, sublayer, legendIndex);
	            break;
	        case "esriSMS":
	            layers = (0, esriSMS.default)(symbol, sourceId, imageList);
	            break;
	        default:
	...
	var symbols$1 = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		'default': symbols,
		__moduleExports: symbols
	}, [symbols]);
	...
	function default_1(symbol, pixelRatio) {
	    var _a, _b;
	    const size = (0, utils$1.ptToPx)(symbol.size || 13);
	    const scale = 2 ** (pixelRatio - 1);
	    const width = (size + 1 * 2 + (((_a = symbol.outline) === null || _a === void 0 ? void 0 : _a.width) || 0) * 2) * scale;
	    const height = width;
	    let canvas = (0, utils$1.createCanvas)(width, height);
	    var ctx = canvas.getContext("2d");
	    ctx.lineWidth =
	        (0, utils$1.ptToPx)(!!symbol.outline ? symbol.outline.width || 1 : 1) * scale;
	    ctx.strokeStyle = !!symbol.outline
	        ? (0, utils$1.rgba)((_b = symbol.outline) === null || _b === void 0 ? void 0 : _b.color)
	        : (0, utils$1.rgba)(symbol.color);
	    ctx.fillStyle = (0, utils$1.rgba)(symbol.color);
	    switch (symbol.style) {
	        case "esriSMSCircle":
	            ctx.beginPath();
	            var x = width / 2;
	        ...
	        case "esriSMSCross":
	            ...
	            ctx.strokeStyle = (0, utils$1.rgba)(symbol.color);
	...
	exports.default = {
	    esriSFSVertical: (strokeStyle = "#000000") => {
	        var canvas = (0, utils$1.createCanvas)(16, 16);
	        var ctx = canvas.getContext("2d");
	...
	class ImageList {
	            ...
	            images: [
	                {
	                    ...
	                    width: (0, utils$1.ptToPx)(symbol.width),
	                    height: (0, utils$1.ptToPx)(symbol.height),
	                },
	            ],
	        });
	        return imageid;
	    ...
	    addEsriSMS(symbol) {
	        ...
	        const images = [1, 2, 3].map((pixelRatio) => {
	            const marker = (0, drawSMS.default)(symbol, pixelRatio);
	            if (pixelRatio === 1)
	                marker.width;
	            return {
	                dataURI: marker.data,
	    ...
	    addEsriSFS(symbol) {
	        const imageId = (0, esmBrowser.v4)();
	        const pattern = fillPatterns.default[symbol.style]((0, utils$1.rgba)(symbol.color));
	        this.imageSets.push({
	            id: imageId,
	            images: [
	...
	var ImageList = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		'default': ImageList_1,
		__moduleExports: ImageList_1
	}, [ImageList_1]);
	...
	exports.default = (labelingInfo, geometryType, fieldNames) => {
	    return {
	        ...
	        layout: {
	            ...
	            "text-anchor": (0, utils$1.toTextAnchor)(labelingInfo.labelPlacement),
	            "text-size": (0, utils$1.ptToPx)(labelingInfo.symbol.font.size || 13),
	            "symbol-placement": geometryType === "line" ? "line" : "point",
	            "text-max-angle": 20,
	        },
	        paint: {
	            "text-color": (0, utils$1.rgba)(labelingInfo.symbol.color),
	            "text-halo-width": (0, utils$1.ptToPx)(labelingInfo.symbol.haloSize || 0),
	            "text-halo-color": (0, utils$1.rgba)(labelingInfo.symbol.haloColor || [255, 255, 255, 255]),
	            "text-halo-blur": (0, utils$1.ptToPx)(labelingInfo.symbol.haloSize || 0) * 0.5,
	        },
	    };
	};
	...
	async function styleForFeatureLayer(serviceBaseUrl, sublayer, sourceId, serviceMetadata) {
	    ...
	    let layers = [];
	    const imageList = new ImageList.ImageList(serviceMetadata.currentVersion);
	    ...
	    switch (renderer.type) {
	        case "uniqueValue": {
	            ...
	            for (const info of renderer.uniqueValueInfos) {
	                ...
	                layers.push(...(0, symbols$1.symbolToLayers)(info.symbol, sourceId, imageList, serviceBaseUrl, sublayer, legendItemIndex++).map((lyr) => {
	                    var _a;
	            ...
	            if (renderer.defaultSymbol && renderer.defaultSymbol.type) {
	                layers.push(...(0, symbols$1.symbolToLayers)(renderer.defaultSymbol, sourceId, imageList, serviceBaseUrl, sublayer, 0).map((lyr) => {
	        ...
	        case "classBreaks":
	            if (renderer.backgroundFillSymbol) {
	                layers.push(...(0, symbols$1.symbolToLayers)(renderer.backgroundFillSymbol, sourceId, imageList, serviceBaseUrl, sublayer, 0));
	            }
	            ...
	            if (renderer.defaultSymbol && renderer.defaultSymbol.type) {
	                const defaultLayers = await (0, symbols$1.symbolToLayers)(renderer.defaultSymbol, sourceId, imageList, serviceBaseUrl, sublayer, 0);
	            ...
	            break;
	        default:
	            layers = (0, symbols$1.symbolToLayers)(renderer.symbol, sourceId, imageList, serviceBaseUrl, sublayer, 0);
	            break;
	    }
	    if (serviceMetadata.drawingInfo.labelingInfo) {
	        for (const info of serviceMetadata.drawingInfo.labelingInfo) {
	            if (info.labelExpression) {
	                const layer = (0, esriTS.default)(info, serviceMetadata.geometryType, serviceMetadata.fields.map((f) => f.name));
	                layer.source = sourceId;
	                layer.id = (0, utils$1.generateId)();
	                layers.push(layer);
	            }
	        }
	    }
	...
	Object.defineProperty(exports, "ArcGISTiledMapService", { enumerable: true, get: function () { return ArcGISTiledMapService.ArcGISTiledMapService; } });
