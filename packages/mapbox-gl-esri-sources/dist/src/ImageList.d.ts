...
export declare let CANVAS_TO_DATA_URL: (canvas: HTMLCanvasElement) => string;
export declare function setCanvasToDataURLPolyfill(polyfill: (canvas: HTMLCanvasElement) => string): void;
