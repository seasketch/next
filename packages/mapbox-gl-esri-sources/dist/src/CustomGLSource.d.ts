...
export type CustomSourceType = "ArcGISFeatureLayer" | "ArcGISTiledMapService" | "ArcGISDynamicMapService";
 ...
 * MapContextManager.
 */
export interface CustomGLSource<T extends CustomGLSourceOptions, LegendType = LegendItem[] | SingleImageLegend> {
    url: string;
    sourceId: string;
...
//# sourceMappingURL=CustomGLSource.d.ts.map