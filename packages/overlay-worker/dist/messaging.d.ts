...
export declare function sendResultMessage(jobKey: string, result: any, queueUrl: string): Promise<void>;
export declare function sendProgressMessage(jobKey: string, progress: number, queueUrl: string, message?: string): Promise<import("@aws-sdk/client-sqs").SendMessageCommandOutput>;
