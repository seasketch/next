  ...
  const metadataByTableId = useMemo(() => {
    ...
    for (const entry of metadataQuery.data?.tableOfContentsItem
      ...
      next[entry.id] = {
        ...
        additionalReplicateIdentifiers: entry.additionalReplicateIdentifiers,
        replicateLabel: entry.replicateLabel,
        replicateLabelCustom: entry.replicateLabelCustom,
        withinReplicateOperations: entry.withinReplicateOperations,
        acrossReplicateOperations: entry.acrossReplicateOperations,
  ...
  const tableMetadata = useMemo(() => {
    ...
    return (
      metadataByTableId[table.id] || {
        ...
        additionalReplicateIdentifiers: table.additionalReplicateIdentifiers,
