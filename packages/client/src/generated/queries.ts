...
export type GetSpriteDataForScreenshotInput = {
  bookmark?: Maybe<MapBookmarkInput>;
  /**
   * An arbitrary string value with no semantic meaning. Will be included in the
   * payload verbatim. May be used to track mutations by the client.
   */
...
export type GetSpriteDataForScreenshotPayload = {
  __typename?: 'GetSpriteDataForScreenshotPayload';
  /**
   * The exact same `clientMutationId` that was provided in the mutation input,
   * unchanged and unused. May be used by a client to track mutations.
   */
  clientMutationId?: Maybe<Scalars['String']>;
  jsons?: Maybe<Array<Maybe<Scalars['JSON']>>>;
  /** Our root query field type. Allows us to run any query from our mutation payload. */
  query?: Maybe<Query>;
};
...
export type MapBookmarkInput = {
  ...
  postId?: Maybe<Scalars['Int']>;
  projectId?: Maybe<Scalars['Int']>;
  screenshotJobStatus?: Maybe<WorkerJobStatus>;
  selectedBasemap: Scalars['Int'];
  sidebarState?: Maybe<Scalars['JSON']>;
  sketchNames?: Maybe<Scalars['JSON']>;
  style: Scalars['JSON'];
...
export type Mutation = {
  ...
  getSpriteDataForScreenshot?: Maybe<GetSpriteDataForScreenshotPayload>;
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationGetSpriteDataForScreenshotArgs = {
