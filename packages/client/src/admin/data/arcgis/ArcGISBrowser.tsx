...
export default function ArcGISBrowser() {
  ...
  // TODO: replace with useMapEssentials
  // useEffect(() => {
...
): Partial<DataSourceDetailsFragment> {
  return {
    // TODO: fix id assignment
    id: 1, // || serviceData.mapServerInfo.generatedId,
...
function vectorLayerFromSettings(
  layer: LayerInfo,
  settings?: VectorSublayerSettings
): Partial<DataLayerDetailsFragment> {
