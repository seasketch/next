...
export default function NavSidebar(props: NavSidebarProps) {
  ...
  return (
    <nav
      ...
      className={`flex-shrink-0 w-full lg:w-96 max-w-full max-h-screen overflow-y-auto overscroll-none min-h-screen bg-white border-r border-blue-gray-200 flex flex-col ${props.className}`}
    >
      {props.header && (
