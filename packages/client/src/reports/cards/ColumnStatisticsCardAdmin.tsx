...
export default function ColumnStatisticsCardAdmin({
  config,
  onUpdate,
}: {
  config: AdminConfig;
      ...
      <div>
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              isToggled={Boolean(displayStats.stdDev)}
              onClick={(enabled: boolean) =>
                updateDisplayStats("stdDev", enabled)
              }
            />
          </div>
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              isToggled={Boolean(displayStats.countDistinct)}
              onClick={(enabled: boolean) =>
                updateDisplayStats("countDistinct", enabled)
              }
            />
          </div>
        </div>
