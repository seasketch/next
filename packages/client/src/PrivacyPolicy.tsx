      ...
      <div className="max-w-3xl mx-auto p-4">
        ...
        <div className="markdown-body text-sm">
          <p className="py-2">
            ...
            deal to us. In this policy, we lay out: what data we collect and
            why; how your data is handled; and your rights with respect to your
          ...
          <h2 className="font-bold text-xl my-2">What we collect and why</h2>
          <p className="py-2">
            Our guiding principle is to collect only what we need. Here’s what
            that means in practice:
          </p>
          <h3 className="text-lg font-bold my-2">Identity &amp; access</h3>
          <p className="py-2">
            When you sign up for SeaSketch, we ask for identifying information
            such as your name, email address, and maybe an organization name.
            That’s so you can personalize your new account, and we can send you
            SeaSketch updates and other essential information. We may also send
            you optional surveys from time to time to help us understand how you
            use our products and to make improvements. With your consent, we may
            send you our newsletter and other updates. We sometimes also give
            you the option to add a profile picture that displays in SeaSketch.
          </p>
          <p className="py-2">
            We’ll never sell your personal information to third parties, and we
            won’t use your name or organization in marketing statements without
            your permission either.
          </p>
          <h3 className="text-lg font-bold my-2">Product interactions</h3>
          <p className="py-2">
            We store on our servers the content that you upload or receive or
            maintain in your SeaSketch account. This is so you can use our
            products as intended, for example, to create projects in SeaSketch,
            sketch zones, or post a message in a forum. We keep this content as
            long as your account is active. If you delete your account, we’ll
            delete the content of your account within 30 days. Likewise, if you
            delete a SeaSketch project that you own, the content of that project
            will be deleted within 30 days.&nbsp;
          </p>
          <h3 className="text-lg font-bold my-2">3rd Party Data Sharing</h3>
          <p className="py-2">
            We use the following service providers to provide SeaSketch
          ...
          <h3 className="text-lg font-bold my-2">Website interactions</h3>
          <p className="py-2">
            We collect information about your browsing activity for analytics
            and statistical purposes such as performance testing and
            experimenting with new product designs. This includes, for example,
            your browser and operating system versions, your IP address, which
            SeaSketch projects you visited, what maps you turned on and how long
            they took to load, and which website referred you to us. If you have
            an account and are signed in, these web analytics data are tied to
            your IP address and user account until your account is no longer
            active.&nbsp;
          </p>
          <h3 className="text-lg font-bold my-2">Cookies</h3>
          <p className="py-2">
            We use persistent first-party cookies and some third-party cookies
            to store certain preferences, make it easier for you to use our
            applications, and perform A/B testing as well as support some
            analytics.
          </p>
          <p className="py-2">
            ...
            although SeaSketch may not function properly if you turn cookies
            off.
          </p>
          <h3 className="text-lg font-bold my-2">Voluntary correspondence</h3>
          <p className="py-2">
            When you email the SeaSketch Team with a question or to ask for
            help, we keep that correspondence, including your email address, so
            that we have a history of past correspondence to reference if you
            reach out in the future.
          </p>
          <p className="py-2">
            We also store information you may volunteer, for example, responses
            to surveys. If you take a survey, you may be asked to sign a
          ...
          <p className="py-2">
            ...
            purposes with your express permission, for example, if an error
            occurs that stops an automated process from working and requires
            manual intervention to fix. These are rare cases, and when they
            happen, we look for root cause solutions as much as possible to
            avoid them recurring. We may also access your data if required in
            order to respond to a legal process (see “When required under
          ...
          <p className="py-2">
            ...
            **(see account terms above). Accessing a customer’s account when
            investigating potential abuse is a measure of last resort. We want
            to protect the privacy and safety of both our customers and the
            people reporting issues to us, and we do our best to balance those
            responsibilities throughout the process. If we discover you are
            using our products for a restricted purpose, we will take action as
          ...
          <p className="py-2">
            SeaSketch is developed and located in California and all data
            infrastructure is located in the U.S. and the Amazon Web Services
            network (i.e., USA, Brazil, Ireland, and Australia).&nbsp;
          </p>
          <ul>
            <li>
              ...
              assistance treaty or agreement. It is our policy to notify
              affected users before we share data unless we are legally
              prohibited from doing so, and except in some emergency cases.
            </li>
            <li>
              Preservation requests. Similarly, our policy is to comply with
              requests to preserve data only if compelled by the U.S. Federal
              Stored Communications Act, 18 U.S.C. Section 2703(f), or by a
              properly served U.S. subpoena for civil matters. We do not share
              preserved data unless required by law or compelled by a court
              order that we choose not to appeal. Furthermore, unless we receive
              a proper warrant, court order, or subpoena before the required
              preservation period expires, we will destroy any preserved copies
              of customer data at the end of the preservation period.
            </li>
            <li>
          ...
          <p className="py-2">
            We strive to apply the same data rights to all customers, regardless
            of their location. Some of these rights include:
          </p>
          <ul>
            <li>
            ...
            <li>
              **Right to Erasure / “To Be Forgotten”. **This is your right to
              ...
              data deletion requests may prevent you from using SeaSketch
            ...
            <li>
              ...
              to transmit it to another party. If you want to export data from
              your accounts, you can do so directly within the SeaSketch
              application.&nbsp;
            </li>
            <li>
              <strong>
          ...
          <p className="py-2">
            ...
            or at Office of Technology &amp; Industry Alliances, 342 Lagoon
            Road, Mail Code 2055, Santa Barbara, CA 93106-2055.
          </p>
          <p className="py-2">
          ...
          <h3 className="text-lg font-bold my-2">How we secure your data</h3>
          <p className="py-2">
            ...
            backups are also encrypted. Most data are not encrypted while they
            live in our database (since they need to be ready to send to you
            when you need them).&nbsp;
          </p>
          <h3 className="text-lg font-bold my-2">
          ...
          <p className="py-2">
            ...
            content. Anything you trash in your product accounts while they are
            active will be kept in an inaccessible trash can for about 15
            days.&nbsp; The trashed content may remain on our active servers for
            another 15 days during which content may be retrieved upon request.
            After a total of 30 days, the content will be deleted from our
            backups forever.&nbsp;
          </p>
          <p className="py-2">
            ...
            full within 30 days. This applies both for cases when an account
            owner directly cancels and for auto-canceled accounts.
          </p>
          <h3 className="text-lg font-bold my-2">Location of site and data</h3>
          <p className="py-2">
            Our products are hosted on Amazon Web Services (AWS) located in the
            USA, Brazil, Ireland, and Australia.&nbsp;
          </p>
          <h3 className="text-lg font-bold my-2">Changes &amp; questions</h3>
          <p className="py-2">
            ...
            the changes to our policies since 2022 on GitHub. Whenever we make a
          ...
          <p className="py-2">
            ...
            <a
              className="text-primary-500 underline"
              href="mailto:admin@seasketch.org"
            >
              admin@seasketch.org
            </a>{" "}
            and we’ll be happy to try to answer them!
          </p>
        </div>
      </div>
    </div>
