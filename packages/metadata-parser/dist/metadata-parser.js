            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (data["gmd:MD_Metadata"]) {
                        return [2 /*return*/, (0, iso19139ToProseMirror_1.iso19139ToProseMirror)(data)];
                    }
                    else if (data["metadata"] && data["metadata"]["idinfo"]) {
                        return [2 /*return*/, (0, fgdcToProsemirror_1.fgdcToProseMirror)(data)];
                    }
                    else {
                ...
                case 2:
                    error_1 = _a.sent();
                    throw new Error("Error processing XML: ".concat(error_1.message));
