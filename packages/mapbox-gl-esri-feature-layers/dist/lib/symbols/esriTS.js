...
exports.default = (labelingInfo, geometryType, fieldNames) => {
    ...
    return {
        ...
        layout: {
            ...
            "text-anchor": utils_1.toTextAnchor(labelingInfo.labelPlacement),
            "text-size": utils_1.ptToPx(labelingInfo.symbol.font.size || 13),
            "symbol-placement": geometryType === "line" ? "line" : "point",
            "text-max-angle": 20,
        },
        paint: {
            "text-color": utils_1.rgba(labelingInfo.symbol.color),
            "text-halo-width": utils_1.ptToPx(labelingInfo.symbol.haloSize || 0),
            "text-halo-color": utils_1.rgba(labelingInfo.symbol.haloColor || [255, 255, 255, 255]),
            "text-halo-blur": utils_1.ptToPx(labelingInfo.symbol.haloSize || 0) * 0.5,
        },
    };
};
/** @hidden */
