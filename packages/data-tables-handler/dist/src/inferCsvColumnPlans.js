...
exports.CSV_NULL_STRINGS_WITH_NA = exports.CSV_NULL_STRINGS_BASE = void 0;
exports.nullstrOption = nullstrOption;
exports.isNumericDuckDbType = isNumericDuckDbType;
...
function isNumericDuckDbType(type) {
 ...
 */
function decideNaNullHandling(strictType, naNullType, naLiteralCount, naLooksLikeValidCode) {
...
async function naLooksLikeValidCode(conn, quotedColumn, naLiteralCount) {
    if (naLiteralCount === 0) {
        return false;
    }
...
async function inferCsvColumnPlans(conn, csvPath, readCsvOptionsSuffix) {
