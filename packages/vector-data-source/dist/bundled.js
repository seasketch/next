...
var require_rbush = __commonJS({
  "node_modules/rbush/rbush.js"(exports, module2) {
    (function(global, factory) {
      ...
      RBush2.prototype.search = function search(bbox2) {
        var node = this.data;
        var result = [];
      ...
      RBush2.prototype.collides = function collides(bbox2) {
        var node = this.data;
        if (!intersects(bbox2, node)) {
          return false;
        }
      ...
      RBush2.prototype._chooseSubtree = function _chooseSubtree(bbox2, node, level, path) {
        while (true) {
          path.push(node);
      ...
      RBush2.prototype._adjustParentBBoxes = function _adjustParentBBoxes(bbox2, path, level) {
...
// node_modules/union-subdivided-polygons/dist/src/getEvents.js
var require_getEvents = __commonJS({
  "node_modules/union-subdivided-polygons/dist/src/getEvents.js"(exports) {
    "use strict";
    ...
    function getEventsAndInteriorRings(collection, originalIdField) {
      ...
      for (var fi = 0; fi < collection.features.length; fi++) {
        ...
        var bbox2 = feature2.bbox || bbox_1.default(feature2);
        bboxes.push(bbox2);
        var polygons = void 0;
        ...
        var _loop_1 = function(polygon2) {
          ...
          var _loop_2 = function() {
            ...
            var onLeft = position[0] === bbox2[0];
            var onRight = position[0] === bbox2[2];
            var onBottom = position[1] === bbox2[1];
            var onTop = position[1] === bbox2[3];
    ...
    exports.default = getEventsAndInteriorRings;
...
// node_modules/union-subdivided-polygons/dist/src/makePolygons.js
var require_makePolygons = __commonJS({
  "node_modules/union-subdivided-polygons/dist/src/makePolygons.js"(exports) {
    "use strict";
    var __spreadArrays = exports && exports.__spreadArrays || function() {
      for (var s = 0, i = 0, il = arguments.length; i < il; i++)
        s += arguments[i].length;
...
// node_modules/union-subdivided-polygons/dist/src/eventIndex.js
var require_eventIndex = __commonJS({
  "node_modules/union-subdivided-polygons/dist/src/eventIndex.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/union-subdivided-polygons/dist/index.js
var require_dist = __commonJS({
  "node_modules/union-subdivided-polygons/dist/index.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
// lib/index.ts
var import_union_subdivided_polygons = __toESM(require_dist());
var getBBox = (feature2) => {
  return feature2.bbox || es_default(feature2);
};
var sources = [];
var DEFAULTS = {
  cacheSize: 250,
...
var VectorDataSource = class {
  ...
  async identifyBundles(bbox2) {
    await this.fetchMetadata();
    if (this.initError) {
      throw this.initError;
    }
    return this.bundleIndex.search(bbox2[0], bbox2[1], bbox2[2], bbox2[3]);
  }
  ...
  async hint(bbox2) {
    const bundleIds = await this.identifyBundles(bbox2);
  ...
  async prefetch(bbox2, feature2) {
    let bundleIds = await this.identifyBundles(bbox2);
    if (feature2) {
  ...
  async fetchUnion(bbox2, unionProperty) {
    const features = await this.fetch(bbox2);
    if (features.length !== 0) {
      return (0, import_union_subdivided_polygons.union)(featureCollection(features), unionProperty || void 0);
    } else {
