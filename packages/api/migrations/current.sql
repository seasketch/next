...
revoke all on function public.set_overlay_data_table_visualization_settings(integer, text[], text[], text[], text[], jsonb, text, text[], text, text, jsonb, jsonb) from public;
grant all on function public.set_overlay_data_table_visualization_settings(integer, text[], text[], text[], text[], jsonb, text, text[], text, text, jsonb, jsonb) to seasketch_user;
