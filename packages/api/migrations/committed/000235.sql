...
drop function if exists sprites_for_bookmark;
create or replace function map_bookmarks_sprites(bookmark map_bookmarks)
  returns sprites
  language sql
  security definer
  stable
...
grant execute on function map_bookmarks_sprites to anon;


drop function if exists get_sprite_data_for_screenshot;
create or replace function get_sprite_data_for_screenshot(bookmark map_bookmarks)
  returns jsonb[]
  language sql
  security definer
  as $$
...
grant execute on function get_sprite_data_for_screenshot to anon;
