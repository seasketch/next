--! Previous: sha1:c8e543ec0ba7d09436cb97ff9338be85214be69d
--! Hash: sha1:23ddb518a2e6237f93687cd59c8f61886b489bff

-- Enter migration here
update data_source_types set description = 'GeoJSON hosted on SeaSketch CDN' where type = 'seasketch-vector';
insert into data_source_types (type, description) values ('seasketch-raster', 'Raster data hosting on SeaSketch CDN') on conflict do nothing;
