--! Previous: sha1:729f58c211f55507246713f24b16551f240ed43a
--! Hash: sha1:93c4237cb9ea16b9ef423006233e4b3b63555ce9

-- Enter migration here
drop table if exists deleted_data_layers;

drop function if exists public.after_insert_or_update_deleted_data_layers;

create table if not exists deleted_geojson_objects (
...
CREATE OR REPLACE FUNCTION public.after_deleted__data_sources() RETURNS trigger
...
CREATE TRIGGER _500_gql_after_deleted__data_sources AFTER DELETE ON data_sources FOR EACH ROW EXECUTE FUNCTION public.after_deleted__data_sources();
