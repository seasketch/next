--! Previous: sha1:367bf26983ec140b3c29c999cbde0ea4551a93f3
--! Hash: sha1:ac2da08fddc58b86bf51f8e4cca890972fab5689

-- Enter migration here
alter table projects add column if not exists table_of_contents_last_published timestamp without time zone;
grant select(table_of_contents_last_published) on projects to anon;
