--! Previous: sha1:70958ca0af527ee54ead2c6d90a6ef72f103f6c9
--! Hash: sha1:59babdcc365a2d4cc6220561e9be6b8e5af22e21
...
alter table data_sources add column if not exists upload_task_id uuid references data_upload_tasks(id);
