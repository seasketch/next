...
--
-- Name: summary_stats_interval; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.summary_stats_interval AS ENUM (
    'day',
    'week',
    'month'
);
...
--
-- Name: daily_project_activity_stats; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.daily_project_activity_stats (
    id integer NOT NULL,
    project_id integer NOT NULL,
...
--
-- Name: daily_project_activity_stats_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.daily_project_activity_stats ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.daily_project_activity_stats_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: daily_project_activity_stats daily_project_activity_stats_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.daily_project_activity_stats
    ADD CONSTRAINT daily_project_activity_stats_pkey PRIMARY KEY (id);
...
--
-- Name: daily_project_activity_stats daily_project_activity_stats_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.daily_project_activity_stats
    ADD CONSTRAINT daily_project_activity_stats_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id);
...
--
-- Name: daily_project_activity_stats; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.daily_project_activity_stats ENABLE ROW LEVEL SECURITY;
...
--
-- Name: daily_project_activity_stats select_daily_project_activity_stats_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY select_daily_project_activity_stats_policy ON public.daily_project_activity_stats FOR SELECT USING (public.session_is_admin(project_id));
...
--
-- Name: TABLE daily_project_activity_stats; Type: ACL; Schema: public; Owner: -
--

GRANT SELECT ON TABLE public.daily_project_activity_stats TO seasketch_user;
