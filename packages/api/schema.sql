...
CREATE TRIGGER set_parent_collection_updated_at BEFORE INSERT OR DELETE OR UPDATE ON public.sketches FOR EACH ROW WHEN ((pg_trigger_depth() = 0)) EXECUTE FUNCTION public.trigger_update_collection_updated_at();
