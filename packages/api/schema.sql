...
--
-- Name: dashboard_stats; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: after_deleted__data_upload_outputs(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.after_deleted__data_upload_outputs() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
  BEGIN
...
--
-- Name: generate_export_id(integer, text, jsonb); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: generate_label(integer, jsonb); Type: FUNCTION; Schema: public; Owner: -
--
...
CREATE TABLE public.form_elements (
    ...
    generated_export_id text GENERATED ALWAYS AS (public.generate_export_id(id, export_id, body)) STORED NOT NULL,
    generated_label text GENERATED ALWAYS AS (public.generate_label(id, body)) STORED NOT NULL,
...
COMMENT ON COLUMN public.map_bookmarks.client_generated_thumbnail IS 'Generated by clients. Should not be used if authorative thumbnail (image_id) is available.';
...
CREATE FUNCTION public.camel_case(snake_case text) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
begin
  return
...
--
-- Name: collect_prosemirror_text_nodes(jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.collect_prosemirror_text_nodes(doc jsonb) RETURNS jsonb
    LANGUAGE plpgsql IMMUTABLE
    AS $$
BEGIN
...
--
-- Name: FUNCTION collect_prosemirror_text_nodes(doc jsonb); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.collect_prosemirror_text_nodes(doc jsonb) IS '@omit';
...
--
-- Name: collect_text_from_prosemirror_body(jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.collect_text_from_prosemirror_body(body jsonb) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
    declare
      output text;
...
CREATE FUNCTION public.collect_text_from_prosemirror_body_for_label(body jsonb) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
    declare
      output text;
...
--
-- Name: create_map_bookmark(text, boolean, jsonb, text[], integer, jsonb, jsonb, integer[], integer[], jsonb, text, jsonb, jsonb, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: extract_all_titles(jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.extract_all_titles(doc jsonb) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
DECLARE
    lang text;
...
--
-- Name: FUNCTION extract_all_titles(doc jsonb); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.extract_all_titles(doc jsonb) IS '@omit';
...
CREATE FUNCTION public.extract_title(lang text, doc jsonb) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
BEGIN
...
--
-- Name: FUNCTION extract_title(lang text, doc jsonb); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.extract_title(lang text, doc jsonb) IS '@omit';
...
--
-- Name: forums_can_post(public.forums); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.forums_can_post(forum public.forums) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
    with acl as (
...
--
-- Name: forums_last_post_date(public.forums); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.forums_last_post_date(forum public.forums) RETURNS timestamp with time zone
    LANGUAGE sql STABLE
    AS $$
    select 
      created_at 
...
--
-- Name: forums_post_count(public.forums); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: forums_read_acl(public.forums); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.forums_read_acl(forum public.forums) RETURNS public.access_control_lists
    LANGUAGE sql STABLE
    AS $$
...
--
-- Name: forums_topic_count(public.forums); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: forums_write_acl(public.forums); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.forums_write_acl(forum public.forums) RETURNS public.access_control_lists
    LANGUAGE sql STABLE
    AS $$
...
CREATE FUNCTION public.get_all_sketch_toc_children(parent_id integer, parent_type public.sketch_child_type) RETURNS text[]
    LANGUAGE plpgsql
    AS $$
  declare
    ids text[] = '{}';
...
--
-- Name: FUNCTION get_all_sketch_toc_children(parent_id integer, parent_type public.sketch_child_type); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_all_sketch_toc_children(parent_id integer, parent_type public.sketch_child_type) IS '@omit';
...
--
-- Name: get_supported_languages(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_supported_languages(); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_supported_languages() IS '@omit';
...
--
-- Name: jsonb_array_to_string(jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.jsonb_array_to_string(jsonb_array jsonb) RETURNS text
    LANGUAGE plpgsql
    AS $$
DECLARE
    element jsonb;
...
--
-- Name: FUNCTION jsonb_array_to_string(jsonb_array jsonb); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.jsonb_array_to_string(jsonb_array jsonb) IS '@omit';
...
CREATE FUNCTION public.lcfirst(word text) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
begin
...
--
-- Name: projects_latest_posts(public.projects); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.projects_latest_posts(project public.projects) RETURNS SETOF public.posts
    LANGUAGE sql STABLE
    AS $$
...
--
-- Name: search_overlays(text, text, integer, boolean, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.search_overlays(lang text, query text, "projectId" integer, draft boolean, "limit" integer) RETURNS SETOF public.search_result
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
    declare
...
--
-- Name: FUNCTION search_overlays(lang text, query text, "projectId" integer, draft boolean, "limit" integer); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.search_overlays(lang text, query text, "projectId" integer, draft boolean, "limit" integer) IS '@simpleCollections only';
...
--
-- Name: to_graphql_id(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.to_graphql_id(type text, id integer) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
    begin
...
--
-- Name: toggle_language_support(text, text, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.toggle_language_support(slug text, code text, enable boolean) RETURNS public.projects
    LANGUAGE sql SECURITY DEFINER
    AS $$
    update projects 
...
--
-- Name: traverse_prosemirror_nodes(jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.traverse_prosemirror_nodes(node jsonb) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    result jsonb := '[]'::jsonb;
...
--
-- Name: FUNCTION traverse_prosemirror_nodes(node jsonb); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: visitor_metrics; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: visitor_metrics(public.activity_stats_period); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION visitor_metrics(period public.activity_stats_period); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.visitor_metrics(period public.activity_stats_period) IS '@simpleCollections only';
...
CREATE FUNCTION public.visitors(period public.activity_stats_period) RETURNS SETOF public.visitors
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
    select
      *
...
--
-- Name: FUNCTION visitors(period public.activity_stats_period); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.visitors(period public.activity_stats_period) IS '@simpleCollections only';
...
--
-- Name: deleted_data_upload_outputs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.deleted_data_upload_outputs (
    id integer NOT NULL,
    remote text NOT NULL,
...
--
-- Name: deleted_data_upload_outputs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.deleted_data_upload_outputs ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.deleted_data_upload_outputs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: deleted_data_upload_outputs deleted_data_upload_outputs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deleted_data_upload_outputs
    ADD CONSTRAINT deleted_data_upload_outputs_pkey PRIMARY KEY (id);
...
--
-- Name: visitors unique_interval_timestamp; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.visitors
    ADD CONSTRAINT unique_interval_timestamp UNIQUE ("interval", "timestamp");
...
--
-- Name: visitor_metrics visitor_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fts_ar_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_ar_idx ON public.table_of_contents_items USING gin (fts_ar);


--
-- Name: fts_da_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_da_idx ON public.table_of_contents_items USING gin (fts_da);


--
-- Name: fts_de_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: fts_en_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_en_idx ON public.table_of_contents_items USING gin (fts_en);


--
-- Name: fts_es_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_es_idx ON public.table_of_contents_items USING gin (fts_es);


--
-- Name: fts_fr_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_fr_idx ON public.table_of_contents_items USING gin (fts_fr);


--
-- Name: fts_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_id_idx ON public.table_of_contents_items USING gin (fts_id);


--
-- Name: fts_it_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_it_idx ON public.table_of_contents_items USING gin (fts_it);


--
-- Name: fts_lt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_lt_idx ON public.table_of_contents_items USING gin (fts_lt);


--
-- Name: fts_nl_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_nl_idx ON public.table_of_contents_items USING gin (fts_nl);


--
-- Name: fts_no_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_no_idx ON public.table_of_contents_items USING gin (fts_no);


--
-- Name: fts_pt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_pt_idx ON public.table_of_contents_items USING gin (fts_pt);


--
-- Name: fts_ro_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_ro_idx ON public.table_of_contents_items USING gin (fts_ro);


--
-- Name: fts_ru_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_ru_idx ON public.table_of_contents_items USING gin (fts_ru);


--
-- Name: fts_simple_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_simple_idx ON public.table_of_contents_items USING gin (fts_simple);


--
-- Name: fts_sv_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fts_sv_idx ON public.table_of_contents_items USING gin (fts_sv);
...
--
-- Name: visitors_interval; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX visitors_interval ON public.visitors USING btree ("interval");
...
--
-- Name: data_upload_outputs _500_gql_after_deleted__data_upload_outputs; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER _500_gql_after_deleted__data_upload_outputs AFTER DELETE ON public.data_upload_outputs FOR EACH ROW EXECUTE FUNCTION public.after_deleted__data_upload_outputs();
...
ALTER TABLE ONLY public.data_upload_outputs
    ADD CONSTRAINT data_upload_outputs_data_source_id_fkey FOREIGN KEY (data_source_id) REFERENCES public.data_sources(id) ON DELETE CASCADE;
...
CREATE POLICY select_visitors_policy ON public.visitors FOR SELECT USING (public.session_is_superuser());
...
--
-- Name: FUNCTION after_deleted__data_upload_outputs(); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.after_deleted__data_upload_outputs() FROM PUBLIC;
...
--
-- Name: FUNCTION generate_export_id(id integer, export_id text, body jsonb); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.generate_export_id(id integer, export_id text, body jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION public.generate_export_id(id integer, export_id text, body jsonb) TO anon;


--
-- Name: FUNCTION generate_label(id integer, body jsonb); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.generate_label(id integer, body jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION public.generate_label(id integer, body jsonb) TO anon;
...
--
-- Name: FUNCTION camel_case(snake_case text); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.camel_case(snake_case text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.camel_case(snake_case text) TO anon;
...
--
-- Name: FUNCTION collect_prosemirror_text_nodes(doc jsonb); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.collect_prosemirror_text_nodes(doc jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION public.collect_prosemirror_text_nodes(doc jsonb) TO anon;
...
--
-- Name: FUNCTION collect_text_from_prosemirror_body_for_label(body jsonb); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.collect_text_from_prosemirror_body_for_label(body jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION public.collect_text_from_prosemirror_body_for_label(body jsonb) TO anon;
...
GRANT ALL ON FUNCTION public.dashboard_stats() TO seasketch_user;
...
--
-- Name: FUNCTION extract_all_titles(doc jsonb); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.extract_all_titles(doc jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION public.extract_all_titles(doc jsonb) TO anon;
...
REVOKE ALL ON FUNCTION public.extract_title(lang text, doc jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION public.extract_title(lang text, doc jsonb) TO anon;
...
--
-- Name: FUNCTION forums_can_post(forum public.forums); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.forums_can_post(forum public.forums) FROM PUBLIC;
GRANT ALL ON FUNCTION public.forums_can_post(forum public.forums) TO anon;


--
-- Name: FUNCTION forums_last_post_date(forum public.forums); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.forums_last_post_date(forum public.forums) FROM PUBLIC;
GRANT ALL ON FUNCTION public.forums_last_post_date(forum public.forums) TO anon;


--
-- Name: FUNCTION forums_post_count(forum public.forums); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.forums_post_count(forum public.forums) FROM PUBLIC;
GRANT ALL ON FUNCTION public.forums_post_count(forum public.forums) TO anon;


--
-- Name: FUNCTION forums_read_acl(forum public.forums); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.forums_read_acl(forum public.forums) FROM PUBLIC;
GRANT ALL ON FUNCTION public.forums_read_acl(forum public.forums) TO seasketch_user;


--
-- Name: FUNCTION forums_topic_count(forum public.forums); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.forums_topic_count(forum public.forums) FROM PUBLIC;
GRANT ALL ON FUNCTION public.forums_topic_count(forum public.forums) TO anon;


--
-- Name: FUNCTION forums_write_acl(forum public.forums); Type: ACL; Schema: public; Owner: -
--
...
REVOKE ALL ON FUNCTION public.get_all_sketch_toc_children(parent_id integer, parent_type public.sketch_child_type) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_all_sketch_toc_children(parent_id integer, parent_type public.sketch_child_type) TO seasketch_user;
...
--
-- Name: FUNCTION get_supported_languages(); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.get_supported_languages() FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_supported_languages() TO anon;
...
--
-- Name: FUNCTION jsonb_array_to_string(jsonb_array jsonb); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.jsonb_array_to_string(jsonb_array jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION public.jsonb_array_to_string(jsonb_array jsonb) TO anon;
...
--
-- Name: FUNCTION lcfirst(word text); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.lcfirst(word text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.lcfirst(word text) TO anon;
...
--
-- Name: FUNCTION projects_latest_posts(project public.projects); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION search_overlays(lang text, query text, "projectId" integer, draft boolean, "limit" integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.search_overlays(lang text, query text, "projectId" integer, draft boolean, "limit" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION public.search_overlays(lang text, query text, "projectId" integer, draft boolean, "limit" integer) TO anon;
...
--
-- Name: FUNCTION to_graphql_id(type text, id integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.to_graphql_id(type text, id integer) FROM PUBLIC;
GRANT ALL ON FUNCTION public.to_graphql_id(type text, id integer) TO anon;
...
--
-- Name: FUNCTION toggle_language_support(slug text, code text, enable boolean); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.toggle_language_support(slug text, code text, enable boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION public.toggle_language_support(slug text, code text, enable boolean) TO seasketch_user;
...
--
-- Name: FUNCTION topics_posts_count(topic public.topics); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.topics_posts_count(topic public.topics) FROM PUBLIC;
GRANT ALL ON FUNCTION public.topics_posts_count(topic public.topics) TO anon;
...
--
-- Name: FUNCTION traverse_prosemirror_nodes(node jsonb); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION visitor_metrics(period public.activity_stats_period); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION visitors(period public.activity_stats_period); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.visitors(period public.activity_stats_period) FROM PUBLIC;
GRANT ALL ON FUNCTION public.visitors(period public.activity_stats_period) TO seasketch_user;
