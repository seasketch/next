...
exports.MVT_THRESHOLD = exports.MAX_OUTPUT_SIZE = void 0;
...
var uploadPipelineShared_2 = require("./uploadPipelineShared");
Object.defineProperty(exports, "MAX_OUTPUT_SIZE", { enumerable: true, get: function () { return uploadPipelineShared_2.MAX_OUTPUT_SIZE; } });
Object.defineProperty(exports, "MVT_THRESHOLD", { enumerable: true, get: function () { return uploadPipelineShared_2.MVT_THRESHOLD; } });
...
enableAiDataAnalyst) {
    ...
    try {
        ...
        if (outputs.find((o) => o.size > uploadPipelineShared_1.MAX_OUTPUT_SIZE)) {
            throw new Error(`One or more outputs exceed ${bytes(uploadPipelineShared_1.MAX_OUTPUT_SIZE)} limit. Was ${bytes(outputs.find((o) => o.size > uploadPipelineShared_1.MAX_OUTPUT_SIZE).size)}`);
        }
