...
export type OverlayWorkerLogFeatureLayerConfig = {
    name: string;
    geometryType: "Polygon" | "MultiPolygon" | "Point" | "LineString" | "MultiLineString";
    fields: Record<string, "string" | "number" | "boolean">;
};
export type OverlayWorkerLogFeatureCallback = (layer: OverlayWorkerLogFeatureLayerConfig, feature: Feature) => void;
/**
 ...
 */
export declare function guaranteeHelpers(helpers?: OverlayWorkerHelpers): GuaranteedOverlayWorkerHelpers;
