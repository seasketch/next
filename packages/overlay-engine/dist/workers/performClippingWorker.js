...
node_worker_threads_1.parentPort === null || node_worker_threads_1.parentPort === void 0 ? void 0 : node_worker_threads_1.parentPort.on("message", (payload) => {
    try {
        const { features, differenceGeoms, subjectFeature } = payload;
        let product = [];
        let forClipping = [];
        ...
        node_worker_threads_1.parentPort.postMessage(sqKm);
    }
    catch (e) {
        node_worker_threads_1.parentPort.postMessage(0);
    }
});
//# sourceMappingURL=performClippingWorker.js.map