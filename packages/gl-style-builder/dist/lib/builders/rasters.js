    ...
    return [
        {
            ...
            metadata: {
                "s:type": visualizationTypes_1.VisualizationType.RGB_RASTER,
            },
        },
    ];
}
    ...
    return [
        {
            ...
            metadata: Object.assign(Object.assign(Object.assign(Object.assign({ "s:palette": colorScale.name }, (reversePalette ? { "s:reverse-palette": true } : {})), stepsMeta), (geostats.bands[0].offset || geostats.bands[0].scale
                ? { "s:respect-scale-and-offset": true }
                : {})), { "s:type": visualizationTypes_1.VisualizationType.CONTINUOUS_RASTER }),
        },
    ];
}
