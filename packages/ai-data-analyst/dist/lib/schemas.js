...
exports.attributionFormattingValidator = exports.attributionFormattingSchema = exports.titleFormattingValidator = exports.titleFormattingSchema = exports.columnIntelligenceValidator = exports.columnIntelligenceSchema = void 0;
...
exports.columnIntelligenceSchema = {
    ...
    properties: {
        ...
        chosen_presentation_column: {
            type: "string",
            description: "If the chosen_presentation_type uses a data-driven style, this is the column to reference. Required for some presentation types.",
        },
        palette: {
            type: "string",
...
exports.columnIntelligenceValidator = ajv.compile(exports.columnIntelligenceSchema);
