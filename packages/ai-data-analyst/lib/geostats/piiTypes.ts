 ...
 */
export type GeostatsRedactionReason =
  | "email"
  | "phone"
  | "government_id"
  | "financial"
...
export function isPIIRedactedAttribute(
  attr: PrunedGeostatsAttribute | PIIRedactedGeostatsAttribute,
): attr is PIIRedactedGeostatsAttribute {
  return (attr as PIIRedactedGeostatsAttribute).piiRedacted === true;
}
